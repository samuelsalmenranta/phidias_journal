...
export const STRATEGIES: StrategySpec[] = [
  mk({
    ...
    notes: [
      "previous_day_red: previous_context_close < previous_context_open. Jos ei täyty, ei treidiä.",
      "gap_pct = (today_02:00_open − prev_context_close) / prev_context_close × 100.",
      "Ehto: abs(gap_pct) ≥ 0.7 %.",
      "Mode fade: gap up = short, gap down = long. Ei first-bar confirmationia.",
      "Entry 02:30 ET candle open. Stop 24 pts, target 72 pts, max hold 4 baria.",
      "Flat viimeistään 05:00 ET.",
    ],
  }),
  mk({
